    ...
    <div class="header">
        ...
        <div class="row">
            <div class="container"style="margin:0px auto" >
                <img class="shadow shadow-lg" src="../images/IMG_20200919_204036.jpg" style="margin: 0px 15px; height:80%; width:35%; border-radius:20px;" />
                <img class="" src="../images/IMG_20200818_160757(1).jpg" style="padding-left:20%; height:75%; width:50%;border-radius:20px; border-collapse:separate; border-color:lightsalmon" />
